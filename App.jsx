...
const PTACalculator = lazy(() => import('./pages/PTACalculator'));
    ...
    <Layout>
      <Suspense fallback={
        ...
        <Routes>
          ...
          <Route path="/pta-tax-calculator" element={<PTACalculator />} />
          <Route path="/salary-tax-calculator" element={<TaxCalculator />} />
          <Route path="/passport-photo-maker" element={<PassportPhoto />} />
